                ...
                <div class="row">
                    ...
                    <div class="form-group col-md">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <select class="form-control" @change="onSelectItem" v-model="selectedMenuId">
                                ...
                                <td>
                                    <input class="form-control text-center" type="number" v-model="selectedQuantity">
                                </td>
                                <td>
                                    <input class="form-control text-center" type="number" v-model="selectedSalePrice">
                                </td>
                                <td>
                                    <input class="form-control text-center" data-item="item_total" type="number" :value="selectedItemTotal">
                                </td>
                ...
                <div class="form-group">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr id="tr-subtotal">
                                <td colspan="3" class="text-right border-right-0 border-bottom-0"><strong>小計</strong>
                                </td>
