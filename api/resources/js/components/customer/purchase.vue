                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number"
                                                :class="['form-control text-center', {'is-invalid': validation.hasError('selectedQuantity')}]"
                                                v-model="selectedQuantity">
                                            <div class="invalid-feedback">{{ validation.firstError('selectedQuantity') }}</div>
                                        </td>
                                        <td>
                                            <input type="number"
                                                :class="['form-control text-center', {'is-invalid': validation.hasError('selectedSalePrice')}]"
