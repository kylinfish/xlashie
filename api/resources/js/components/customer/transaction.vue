        ...
        <tbody>
            <tr v-for="transaction, index in transactions">
                ...
                <td class="text-center">
                    <div class="dropdown">
                        <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-neutral btn-sm text-light items-align-center py-2"><i class="fa fa-ellipsis-h text-muted"></i>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow"><a href="#" class="dropdown-item">顯示</a> <a href="#" class="dropdown-item">編輯</a>
                            <div class="dropdown-divider"></div> <button type="button" title="刪除" class="dropdown-item action-delete">刪除</button>
                        </div>
                    </div>
                </td>
            </tr>
