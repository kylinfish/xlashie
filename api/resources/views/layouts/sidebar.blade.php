<nav class="sidenav navbar navbar-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
    <div class="scroll-wrapper scrollbar-inner" style="position: relative;">
        <div class="scrollbar-inner scroll-content scroll-scrolly_visible"
            style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 303px;">
            <!-- Brand -->
            ...
            <div class="navbar-inner">
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/customers/1">
                                <i class="ni ni-circle-08 text-pink"></i>
                                <span class="nav-link-text">客戶</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#navbar-dashboards" data-toggle="collapse" role="button"
                                ...
                                <span class="nav-link-text">生產</span>
                            </a>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="/products/" class="nav-link">
                                            ...
                                            <span class="sidenav-normal"> 產品 </span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="/menus/" class="nav-link">
                                            <span class="sidenav-mini-icon"> M </span>
                                            <span class="sidenav-normal"> 營業項目 </span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="scroll-element scroll-y scroll-scrolly_visible">
            <div class="scroll-element_outer">
                <div class="scroll-element_size"></div>
                <div class="scroll-element_track"></div>
                <div class="scroll-bar" style="height: 116px; top: 0px;"></div>
            </div>
        </div>
    </div>
</nav>
